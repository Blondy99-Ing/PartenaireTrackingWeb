...
<div class="w-full max-w-md mx-auto z-content">
    ...
    <div class="card-shadow p-8 md:p-10 rounded-xl border">
        ...
        <header class="text-center mb-8">
            ...
            <p class="text-sm text-secondary mt-1">Choisissez un nouveau mot de passe pour votre compte partenaire.</p>
        </header>
        ...
        <form method="POST" action="{{ route('partner.otp.password.reset.perform') }}">
            ...
            <div class="mt-4">
                <label for="password_confirmation" class="block text-sm font-medium font-orbitron">Confirmer le mot de passe</label>
