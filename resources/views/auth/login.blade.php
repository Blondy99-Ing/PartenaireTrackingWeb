...
<head>
    ...
    .light-mode.bg-image::before {
        background-color: rgba(243, 244, 246, 0.10);
    }
    ...
    .input-style:focus {
        ...
        /* halo + ombre */
        box-shadow:
            0 0 0 4px rgba(245, 130, 32, 0.35),
            /* glow */
...
<body class="flex items-center justify-center min-h-screen p-4 light-mode bg-image" id="theme-container">
    ...
    <div class="w-full max-w-md mx-auto z-content">
        ...
        <div class="flex justify-end mb-4">
            <span class="text-sm mr-2 pt-0.5 text-secondary font-orbitron hidden md:block" id="mode-label">Mode
                Clair</span>
            <div id="theme-toggle" class="toggle-switch"></div>
        </div>

        <div class="card-shadow card-glass p-8 md:p-10 rounded-xl border">
            ...
            <header class="text-center mb-8">
                ...
                <div class="mx-auto mb-4 w-20 h-20 md:w-24 md:h-24 rounded-2xl flex items-center justify-center"
                    ...
                    <img src="{{ asset('assets/images/logo_tracking.png') }}" alt="Fleetra"
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" id="password" name="password" required
                        class="mt-1 block w-full px-4 py-2 border rounded-lg input-style" placeholder="••••••••">
                </div>
    ...
    <div id="forgotModal" class="fixed inset-0 hidden items-center justify-center z-50">
        ...
        <div class="relative z-10 w-full max-w-md card-shadow p-6 md:p-8 rounded-xl border">
            <div class="flex items-start justify-between mb-4">
                ...
                <button type="button" class="text-secondary hover:text-primary text-2xl leading-none"
                    data-close="forgotModal">×</button>
            </div>
